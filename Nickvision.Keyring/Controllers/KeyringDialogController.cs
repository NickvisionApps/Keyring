...
namespace Nickvision.Keyring.Controllers;
...
public class KeyringDialogController
{
    ...
    /// </summary>
    public bool IsValid => !(Keyring == null && Models.Keyring.Exists(_keyringName));
    ...
    public KeyringDialogController(string name, Models.Keyring? keyring)
    {
    ...
    public bool EnableKeyring(string password)
    {
        if(Keyring == null)
        {
            ...
            try
            {
                Keyring = Models.Keyring.Access(_keyringName, password);
                return true;
            }
            catch
            {
